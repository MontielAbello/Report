...
Experimental validation will be performed by taking range measurements of a known environment using the Hokuyo UBG-04LX-FO1 scanning laser range-finder. These measurements will be used to quantify the performance of the observer under real-world conditions.
