...
\begin{figure}
	...
	\begin{tikzpicture} [scale = 3,tdplot_main_coords] %fix main coords!!!
		...
		%labels
		\node [red] at (-0.4,9.25,0.1) {${^{A}\mathbf{s}(ii)}$};
		\node [red] at (-1.6,9.25,0.1) {${^{A}\mathbf{s}(ii-1)}$};
		\node [red] at (-0.2,9.25,1.3) {${^{A}\mathbf{s}(ii-n_{scans})}$};	
		\node [red] at (-1.3,9.25,1.3) {${^{A}\mathbf{s}(ii-1-n_{scans})}$};
