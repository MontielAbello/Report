\begin{figure}
	...
	\end{tikzpicture}
	  \caption{Orientation update scheme: intersection of the scan directions with the surfaces of the measured and predicted cubes are used to determine the surface normals. }
