...
Consider a system ...
Given known something, unknown something, an state observer is. 
...
\begin{equation}
	\dot{\hat{x}} = f(\hat{x},u(t),y(t)-\hat{y}(t))
\end{equation}
where function $f$ is also invariant to actions of $\mathbf{G}$.
