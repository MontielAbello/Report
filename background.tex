...
structure for nonlinear observer - something about Luenberger?
This form of observer was developed by Luenberger \cite{luenberger1966observers}, and is often referred to as a \textit{Luenberger observer}.
\begin{equation}
...
dynamics invariant to some action of a Lie group $\mathbf{G}$, invariant observer has form
\begin{equation}
	\dot{\hat{x}} = h(\hat{x},u(t),y(t)-\hat{y}(t))
\end{equation}
where function $h$ is also invariant to actions of $\mathbf{G}$.
