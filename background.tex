...
\subsection{Rigid Body Kinematics}
	...
	\subsubsection{\textbf{SO}(3)}	
		...
		$3 \times 3$ matrix where magnitude of each column is 1, columns are orthogonal, determinant is +1. These group elements are orthogonal matrices so their columns and rows are orthogonal unit vectors. 
		Group operation matrix is multiplication. Left action is left multiplication of point. 
